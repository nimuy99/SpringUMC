package umc.spring.study.api.code.status;

import lombok.AllArgsConstructor;
import lombok.Getter;
import org.springframework.http.HttpStatus;
import umc.spring.study.api.code.BaseErrorCode;
import umc.spring.study.api.code.ErrorReasonDTO;
...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // MissionError
    MISSION_BAD_REQUEST(HttpStatus.BAD_REQUEST, "MISSION_4001", "유효하지 않은 미션 상태입니다.");
